...
def CreateBackground():
    grassColour = [0.298, 0.686, 0.314]
    waterColour = [0.0, 0.447, 0.741]
...
def CreateSpaceBiome():
    spaceColour = [0.02, 0.02, 0.05]
    planetColour = [0.0, 0.0, 0.5]  
    vertices = [
...
def CreateJungleBiome():
    cliffColour = [0.4,0.3,0.2]
    grasslandColour = [0.2,0.6,0.2]
    vertices = [
